...
void setup_background() {
    ...
    unsigned short* image = (unsigned short*) ground_data;
    for (int i = 0; i < ((ground_width * ground_height) / 2); i++) {
        dest[i] = image[i];
    }
    ...
    *bg1_control = 0 |
    ...
    dest2 = screen_block(24);
    for(int i = 0; i < (battlemap_width * battlemap_height); i++) {
        dest2[i] = battlemap[i];
    }*/
}
